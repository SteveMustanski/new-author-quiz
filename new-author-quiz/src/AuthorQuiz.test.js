...
describe('Author Quiz', () => {
  ...
  describe('When no answer has been selected', () => {
    ...
    it('should have no backround color', () => {
  ...
  describe('When the wrong answer has been selected', () => {
    ...
    it('should have a red backround color', () => {
  ...
  describe('When the first answer has been selected', () => {
    ...
    it('the onAnswerSelcted function is called', () => {
      wrapper.find('.answer').first().simulate('click');
      expect(handleAnswerSelected).toHaveBeenCalled();
    })
    it('the onAnswerSelcted function is called with the shining', () => {
      wrapper.find('.answer').first().simulate('click');
